...
// crear o actualizar el registro de estado_llamada al cargar la pagina
  ...
  <script>
    ...
    async function checkCallStatus() {
      try {
        ...
        // habilita el boton cuando el medico acepta
        ...
        // si la llamada se termina y el boton esta activo o la ventana abierta

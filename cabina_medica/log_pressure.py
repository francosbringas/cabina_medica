...
import time
import sys
import requests # Necesitarás instalar esto: pip3 install requests

# Configuración de pines BCM
PIN_PRESION = 1

# URL de tu script PHP en XAMPP para guardar el estado
# ¡CAMBIA ESTA URL A LA DE TU SERVIDOR XAMPP!
...
def log_pressure_to_db():
    ...
    try:
        ...
        # Enviar el estado a tu script PHP en XAMPP
        try:
